"""
This file is same as basics2, but using Open-Source LLMs
"""
...
# ------------------------------------ Difference in Open Source LLMs ------------------------------------ #
# initiating the encoder/embedder
# by default it uses the all-MiniLM 
...
# fails here, both mistral and openhermes give Asia/Chennai instead of Asia/Kolkata
